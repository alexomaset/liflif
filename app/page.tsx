...
import { Truck, MapPin, Clock, Shield, Share2, Zap, Smartphone, Download, ArrowRight } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: "Track your deliveries with precision, know exactly where your cargo is at any moment."
    },
    {
      icon: <Clock className="w-12 h-12 text-blue-600" />,
      title: "Efficient Routing",
      description: "Optimize routes for faster deliveries, lower fuel costs, and improved efficiency."
    },
    {
      icon: <Shield className="w-12 h-12 text-blue-600" />,
      title: "Secure Transactions",
      description: "Seamless and secure payment integration with multiple payment options."
    }
  ];
    ...
    <div className="bg-white text-gray-900">
      ...
      <header className="bg-blue-600 text-white">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="text-center">
            ...
            <p className="text-xl mb-8">Transforming Delivery Logistics with Smart Technology</p>
            <div className="flex justify-center space-x-4">
              <a href="#" className="bg-white text-blue-600 px-6 py-3 rounded-full font-semibold hover:bg-blue-50">
                Download App
              </a>
              <a href="#" className="border-2 border-white text-white px-6 py-3 rounded-full font-semibold hover:bg-blue-700">
                Learn More
              </a>
            </div>
          </div>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 mt-4">Innovative technology for seamless logistics management</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative flex justify-center">
            <div className={`
              ...
              ${isAppSectionVisible ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0'}
            `}>
                    ...
                    {mobileAppFeatures.map((feature, index) => (
                      <div 
                        ...
                        className={`
                          ...
                          ${isAppSectionVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}
                        `}
                        style={{ transitionDelay: `${index * 200}ms` }}
                      >
                        <div className="flex items-center mb-2">
                          {feature.icon}
                          <h4 className="ml-2 font-semibold text-blue-800">{feature.title}</h4>
                        </div>
          ...
          `}>
            ...
            <p className="text-gray-700 mb-6">
              Experience logistics management like never before with our cutting-edge mobile application. 
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        <h2 className="text-3xl font-bold text-blue-600 mb-6">Ready to Streamline Your Logistics?</h2>
        <p className="text-gray-600 mb-8">Download the LIFLIF app and transform your delivery experience today!</p>
        <div className="flex justify-center space-x-4">
          <a href="#" className="bg-blue-600 text-white px-8 py-4 rounded-full font-semibold hover:bg-blue-700">
            Get Started
          </a>
          <a href="#" className="border-2 border-blue-600 text-blue-600 px-8 py-4 rounded-full font-semibold hover:bg-blue-50">
            Learn More
          </a>
        </div>
      </section>
      ...
      <footer className="bg-blue-800 text-white py-12">
        <div className="container mx-auto px-4 grid md:grid-cols-3 gap-8">
          <div>
            ...
            <p>Revolutionizing logistics through smart technology and innovative solutions.</p>
          </div>
          <div>
